...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, http, imageViewerCtrl) {
        ...
        this.apiEndpoint = 'https://5ad8d1c9dc1baa0014c60c51.mockapi.io/api/br/v1/magic';
        this.images = [];
        this.loadPhotos(0, 0, null);
    }
    HomePage.prototype.loadPhotos = function (found, iterations, scroller) {
        var _this = this;
        ...
        this.http.get(this.apiEndpoint + '/' + this.skip)
            ...
            if (data.id !== undefined) {
                ...
                if (found < _this.take && iterations < _this.iterationLimit) {
                    found++;
                    iterations++;
                    _this.loadPhotos(found, iterations, scroller);
                }
                else {
            ...
            else if (iterations >= _this.iterationLimit && scroller != null) {
                scroller.complete();
            }
        });
    };
    HomePage.prototype.showImage = function (img) {
        var element = document.getElementById('img' + img.id);
        var imageViewer = this.imageViewerCtrl.create(element);
        imageViewer.present();
    };
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"D:\dev\playground\beacon\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>My Photos</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <!--<img style="width:100%; height: auto;" [src]="img.imageUrl" #img{{img.id}}  *ngFor="let img of images" (tap)="showImage($event)" />-->\n  <button ion-item *ngFor="let img of images" (tap)="showImage(img)">\n    <div class="imageHolder" item-start style="width:50px;height:50px;"><img id="{{ \'img\' + img.id }}" style="max-height:50px;max-width:50px;" [src]="img.imageUrl" /></div>\n    <h2>Name: {{img.name}}</h2>\n    <p>ID: {{ img.id }}</p>\n    <ion-icon item-end name="arrow-round-forward"></ion-icon>\n  </button>\n  <ion-infinite-scroll (ionInfinite)="doInfinite($event)">\n      <ion-infinite-scroll-content></ion-infinite-scroll-content>\n    </ion-infinite-scroll>\n</ion-content>\n'/*ion-inline-end:"D:\dev\playground\beacon\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__["a" /* ImageViewerController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__["a" /* ImageViewerController */]) === "function" && _c || Object])
    ], HomePage);
    return HomePage;
    var _a, _b, _c;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ionic_img_viewer__ = __webpack_require__(225);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\dev\playground\beacon\src\app\app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"D:\dev\playground\beacon\src\app\app.html"*/
        }),
