...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.loadPhotos = function (found, iterations) {
        var _this = this;
        ...
        this.http.get(this.apiEndpoint + '/' + this.skip)
            ...
            if (data.id !== undefined) {
                ...
                if (found < _this.take && iterations < _this.iterationLimit) {
                    found++;
                    iterations++;
                    _this.loadPhotos(found, iterations);
                }
                else
